...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/mood-vs-web2.png}\caption{Figure 1. Evolution from platform-owned activity to portable contribution state.}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/mood-network-architecture.png}\caption{Figure 2. MOOD protocol architecture and trust boundaries.}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/contribution-proof-flow.png}\caption{Figure 3. Contribution claim, evidence, verification and decision flow.}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/reputation-engine.png}\caption{Figure 4. Evidence-bearing contributions become versioned reputation snapshots.}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/ai-agent-network.png}\caption{Figure 5. Human, agent and node accountability relationships.}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/blockchain-settlement.png}\caption{Figure 6. Separation between protocol state and optional settlement adapters.}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/genesis-state.png}\caption{Figure 7. Proposed genesis state and first verifiable transition.}\end{figure}
