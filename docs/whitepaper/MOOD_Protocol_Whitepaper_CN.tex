...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/mood-vs-web2.png}\caption{图 1：从平台所有的活动记录走向可携带的贡献状态。}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/mood-network-architecture.png}\caption{图 2：MOOD 协议架构与信任边界。}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/contribution-proof-flow.png}\caption{图 3：贡献声明、证据、验证与决定流程。}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/reputation-engine.png}\caption{图 4：携带证据的贡献形成版本化信誉快照。}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/ai-agent-network.png}\caption{图 5：人类、Agent 与节点之间的责任关系。}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/blockchain-settlement.png}\caption{图 6：协议状态与可选结算 Adapter 之间的边界。}\end{figure}
...
\begin{figure}[ht]\centering\includegraphics[width=.94\linewidth]{figures/genesis-state.png}\caption{图 7：提议 Genesis 状态与第一次可验证转换。}\end{figure}
