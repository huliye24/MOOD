...
const documents:DocumentEntry[]=[
  ...
  {title:"MOOD Whitepaper",description:"An open coordination protocol and digital world for human and machine agency.",kind:"Protocol",version:"0.1",href:"/whitepaper",rawHref:"/whitepaper/raw",keywords:["protocol","identity","proof","agents","nodes","governance"]},
];
export default function LibraryPage(){
  ...
  return <main className="mood-library">
    <nav className="library-nav" aria-label="Library navigation"><Link className="library-brand" href="/"><img src="/moodify-brand-logo.png" alt=""/><span>MOOD</span></Link><div><Link href="/">World</Link><span aria-current="page">Library</span></div></nav>
    ...
    <footer className="library-footer"><Link className="library-brand" href="/"><img src="/moodify-brand-logo.png" alt=""/><span>MOOD</span></Link><p>One world. One public memory.</p><a href="https://github.com/huliye24/MOOD" target="_blank" rel="noreferrer">GitHub ↗</a></footer>
  </main>;
}
